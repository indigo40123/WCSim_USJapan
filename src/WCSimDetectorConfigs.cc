...
void WCSimDetectorConstruction::Set_SNS_FTS_40perCent_2m()
{
  G4cout << " Initializing WCSimDetectorConstruction::Set_SNS_FTS_40perCent_2m " << G4endl;
  WCDetectorName = "SNS_FTS_40perCent";
  WCIDCollectionName = WCDetectorName +"-glassFaceWCPMT";
  WCSimPMTObject * PMT = CreatePMTObject("PMT3inch", WCIDCollectionName);
  WCPMTName           = PMT->GetPMTName();
  WCPMTExposeHeight   = PMT->GetExposeHeight();
  WCPMTRadius         = PMT->GetRadius();
  WCIDDiameter          = 3.0*m; //inner detector diameter
  WCIDHeight            = 2.0*m; //"" "" height
  WCBarrelPMTOffset     = 0.0*m; //offset from vertical
  WCPMTperCellHorizontal= 1;
  WCPMTperCellVertical  = 1; 
  WCPMTPercentCoverage  = 78.0;
...
void WCSimDetectorConstruction::Set_SNS_FTS_78perCent_10mm_2m()
{
  G4cout << " Initializing WCSimDetectorConstruction::Set_SNS_FTS_78perCent_2m " << G4endl;
  WCDetectorName = "SNS_FTS_78perCent";
  WCIDCollectionName = WCDetectorName +"-glassFaceWCPMT";
  WCSimPMTObject * PMT = CreatePMTObject("PMT3inch", WCIDCollectionName);
  //WCSimPMTObject * PMT = CreatePMTObject("PMT10mm", WCIDCollectionName);
  WCPMTName           = PMT->GetPMTName();
  WCPMTExposeHeight   = PMT->GetExposeHeight();
  WCPMTRadius         = PMT->GetRadius();
  WCIDDiameter          = 3.0*m; //inner detector diameter
