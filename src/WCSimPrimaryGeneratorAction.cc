...
void WCSimPrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
{
  ...
  {      // manual gun operation 
    //G4double detectorRadius = 1.5*m;
    //G4double detectorHeight = 2.0*m;

    //G4double xPos = (2 * G4UniformRand() - 1) * detectorRadius;
    //G4double yPos = (2 * G4UniformRand() - 1) * detectorRadius;
    //G4double zPos = (2 * G4UniformRand() - 1) * detectorHeight / 2.0;
    ...
    // Generate a random direction uniformly over a sphere
